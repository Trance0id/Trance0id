...
---------------------------
После открытия этого невероятного мира web разработки моя жизнь уже не будет прежней!
*   🌍  Живу в городе Воронеже
*   🎨  Работаю над проектом: [react-typescript-project](https://github.com/Trance0id/react-typescript-project)
*   🔬  Изучаю React
